...
function CommunityGuidelines() {
  return (
    <div className='mx-auto max-w-3xl bg-gray-50 py-6 my-12 rounded-xl'>
      <h1>Registration & Community Guidelines</h1>
      <p>
        <strong>
          TO BEGIN SEARCHING FOR CLOTHES OR CREATING CLOTHING LISTINGS FOR
          OTHERS TO FIND, MAKE SURE TO REGISTER FOR AN ACCOUNT OR LOG INTO YOUR
          EXISTING ACCOUNT.
        </strong>
      </p>
      <ol>
        <li>
          ...
          <ol type='a'>
            ...
            <li>
              ...
              preferences in your profile to help other members understand your
              tastes and needs.
            </li>
            <li>
        ...
        <li>
          ...
          <ol type='a'>
            <li>
              Clearly define what types of clothing can be posted (e.g., gently
              used, clean, and in good condition). Follow these criteria to
              maintain the quality of items being exchanged.
            </li>
            <li>
            ...
            <li>
              Upload clear photos of the clothing that accurately represent the
              item's condition, color, and features. High-quality images build
              trust among users.
            </li>
            <li>
        ...
        <li>
          ...
          <ol type='a'>
            <li>
              ...
              discrimination, offensive content, or any behavior that might harm
              the community's positive atmosphere.
            </li>
            <li>
            ...
            <li>
              ...
              and transparency within the community. Be honest and constructive
              in your feedback.
            </li>
          </ol>
        </li>
        <li>
          ...
          <ol type='a'>
            <li>
              Familiarize yourself with the app's privacy settings and use them
              to control what information is visible to others.
            </li>
            <li>
        ...
        <li>
          ...
          <ol type='a'>
            ...
            <li>
              Be open to a fair resolution process mediated by the app's support
              team to address disputes or conflicts between users.
            </li>
          </ol>
        </li>
        <li>
          ...
          <ol type='a'>
            ...
            <li>
              Share tips and information on sustainable clothing practices with
              other users to promote eco-friendly behavior.
            </li>
          </ol>
        </li>
      </ol>
