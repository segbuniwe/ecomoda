        ...
        <Dialog.Panel className='fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-emo-teal px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10'>
          <div className='flex items-center justify-between'>
            ...
            >
              ...
              <XMarkIcon
                className='h-10 w-10 text-emo-tan'
                aria-hidden='true'
              />
            </button>
          </div>
          <div className='mt-6 flow-root'>
            <div className='-my-6 divide-y divide-gray-500/10'>
              <div className='space-y-2 py-6'>
                ...
                <a
                  href='/team'
                  className='-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 mb-8'
                >
                  Support
                </a>
                <div className='pt-8'>
                  ...
                  {!userInfo && (
                    <a
                      href='/login'
                      className='py-6 text-lg font-semibold leading-6 text-gray-900'
                    >
                      Log in
                    </a>
                  )}
